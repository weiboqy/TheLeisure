...
//Synthesize是对属性的实现，实际上是指定setter，getter操作的实力变量名是什么
//@synthesize musicArray;  默认操作的实例变量和属性名同名
//@synthesize musicArray = _musicArray;  指定变量名为等号后的符号
//xcode4.5之后，@synthesize可以省略，默认系统实现的setter和getter中操作了一个实例变量，名称是_属性名  ， 如果重写了setter和getter（都重写了）那么必须得用synthesize
